...
<!--			<li><a href="<?=URL_BASE?>compras/"><i class="fa fa-circle-o"></i> Compras por periodo</a></li> -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=URL_BASE?>frontend/principal"><i class="fa fa-circle-o"></i>GANANCIAS</a></li>
            <li><a href="<?=URL_BASE?>frontend/principal"><i class="fa fa-circle-o"></i> PERDIDAS</a></li>
            <li><a href="<?=URL_BASE?>frontend/principal"><i class="fa fa-circle-o"></i> GASTOS</a></li>           
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
